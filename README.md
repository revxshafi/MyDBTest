...
> **Note from dev:** I'm aware of the major bug in the install command, but I have no intention of fixing it. I might make a v3 of this tool, which will be a dependency for my own projects — I don't really care whether other people use it or not, since I'll be using it for my project the way I want it. Until then, this project might not receive a major update. I'm also new to git, so the commit messages might be a bit off. For more useless information check [NOTES.md](https://github.com/revxshafi/MyDBTest/blob/main/NOTES.md).
